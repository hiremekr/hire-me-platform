...
import { E74RFormPageEN } from './pages/E74RFormPageEN'
import { F2RStudentFormPageEN } from './pages/F2RStudentFormPageEN'
import { F2RIncomeFormPageEN } from './pages/F2RIncomeFormPageEN'
import { E71FormPageEN } from './pages/E71FormPageEN'
import { E74TransferFormPageEN } from './pages/E74TransferFormPageEN'
import { SuccessPageEN } from './pages/SuccessPageEN'
...
app.get('/en', (c) => {
  return c.render(
    <HomePageEN />,
    { title: 'HIRE ME - Foreign Employment Matching Platform' }
  )
})
...
app.get('/en/apply', (c) => {
  return c.render(
    <ApplyPageEN />,
    { title: 'Job Application - HIRE ME' }
  )
})

// 영어 E-7-4R 신청 폼
app.get('/en/apply/e-7-4r', (c) => {
  return c.render(
    <E74RFormPageEN />,
    { title: 'E-7-4R Application - HIRE ME' }
  )
})

// 영어 F-2-R 선택 페이지
app.get('/en/apply/f-2-r', (c) => {
  return c.render(
    <F2RSelectionPageEN />,
    { title: 'F-2-R Visa Selection - HIRE ME' }
  )
})

// 영어 F-2-R 유학생 신청 폼
app.get('/en/apply/f-2-r/student', (c) => {
  return c.render(
    <F2RStudentFormPageEN />,
    { title: 'F-2-R Student Application - HIRE ME' }
  )
})

// 영어 F-2-R 소득요건 신청 폼
app.get('/en/apply/f-2-r/income', (c) => {
  return c.render(
    <F2RIncomeFormPageEN />,
    { title: 'F-2-R Income Application - HIRE ME' }
  )
})

// 영어 E-7-1 신청 폼
app.get('/en/apply/e-7-1', (c) => {
  return c.render(
    <E71FormPageEN />,
    { title: 'E-7-1 Application - HIRE ME' }
  )
})

// 영어 E-7-4 사업장변경 신청 폼
app.get('/en/apply/e-7-4-transfer', (c) => {
  return c.render(
    <E74TransferFormPageEN />,
    { title: 'E-7-4 Transfer Application - HIRE ME' }
  )
})

// 영어 신청 완료 페이지
app.get('/en/apply/success', (c) => {
  return c.render(
    <SuccessPageEN />,
    { title: 'Application Complete - HIRE ME' }
  )
})

// ========================================
// 한국어 페이지 라우트 계속 (Korean Routes Continue)
// ========================================
